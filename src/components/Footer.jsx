          ...
          <div class="grid gap-12 md:grid-cols-4">
              <div class="md:col-span-2">
                  <a aria-label="go home" class="block size-fit" href="/"
                      ><svg
                          class="text-foreground h-6 w-full"
                          viewBox="0 0 797 220"
                          fill="none"
              ...
              <div class="md:col-span-2 md:grid-cols-2 grid  gap-6">
                  <div class="space-y-4 text-sm">
                      <span class="block font-medium">Liens utiles</span>
                      <div className="grid gap-y-3 gap-x-4 grid-cols-4  md:flex md:flex-wrap md:w-full">
                      <a class="text-muted-foreground hover:text-primary block duration-150"><span>Features</span></a>
                      <a class="text-muted-foreground hover:text-primary block duration-150"><span>Solution</span></a>
                      <a class="text-muted-foreground hover:text-primary block duration-150"><span>Customers</span></a>
                      <a class="text-muted-foreground hover:text-primary block duration-150"><span>Pricing</span></a>
                      <a class="text-muted-foreground hover:text-primary block duration-150"><span>Help</span></a>
                      <a class="text-muted-foreground hover:text-primary block duration-150"><span>About</span></a>
                      </div>

                  </div>
                  <div class="space-y-4 text-sm">
                      <span class="block font-medium">Payment Methods</span>
